...
var ContestComponent = /** @class */ (function () {
    function ContestComponent(ContestService, toastr, modalService, fb) {
        ...
        this.contest_validation = this.fb.group({
            ...
            day: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
            month: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
            year: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
            duration: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
            round: [],
            music_type: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
            region: ['', [__WEBPACK_IMPORTED_MODULE_5__angular_forms__["Validators"].required]],
...
var RolesComponent = /** @class */ (function () {
    function RolesComponent(RolesService, toastr, modalService, fb) {
        ...
        this.passwordFormGroup = this.fb.group({
            password: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(6)],
            conf: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(6)]
        }, {
            validator: this.passwordMatchValidator
        });
        this.add_admin = this.fb.group({
            'fname': ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            'lname': ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            'account_type': ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        this.router.events
            ...
            else if (event instanceof __WEBPACK_IMPORTED_MODULE_3__angular_router__["NavigationEnd"] ||
                event instanceof __WEBPACK_IMPORTED_MODULE_3__angular_router__["NavigationCancel"]) {
                _this.loading = false;
            ...
            else if (event instanceof __WEBPACK_IMPORTED_MODULE_3__angular_router__["NavigationError"]) {
                _this.loading = false;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["RouterModule"].forRoot([], { useHash: false })
            ],
...
var ConmmentsComponent = /** @class */ (function () {
    ...
    ConmmentsComponent.prototype.getAllArtistComment = function () {
        var _this = this;
        var data = {
            artist_id: this.artistdata['_id']
        };
        this.CommentsService.getAllCommentsByArtist(data).subscribe(function (response) {
            _this.artistcomments = response['comment'];
        });
    };
    // upvote commnet
    ConmmentsComponent.prototype.upVoteComment = function (id) {
        var _this = this;
        if (this.user && this.user['user']) {
            var data = {
                comment_id: id
            };
            this.CommentsService.upVoteComment(data).subscribe(function (response) {
                _this.getAllArtistComment();
                _this.toastr.success(response['message'], 'Success!');
            }, function (error) {
                _this.toastr.error(error['error'].message, 'Error!');
            });
    ...
    // downvote commnet
    ConmmentsComponent.prototype.downVoteComment = function (id) {
        var _this = this;
        if (this.user && this.user['user']) {
            var data = {
                comment_id: id
            };
            this.CommentsService.downVoteComment(data).subscribe(function (response) {
                _this.getAllArtistComment();
                _this.toastr.success(response['message'], 'Success!');
            }, function (error) {
                _this.toastr.error(error['error'].message, 'Error!');
...
var CommentsService = /** @class */ (function () {
    ...
    CommentsService.prototype.getAllCommentsByArtist = function (data) {
        return this.http.post(this.api_host + "/comment", data);
    };
    // upvote comment
    CommentsService.prototype.upVoteComment = function (data) {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
        return this.http.post(this.api_host + "/user/comment/upvote", data, { headers: this.headers });
    };
    // Downvote comment
    CommentsService.prototype.downVoteComment = function (data) {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
...
var ArtistProfileComponent = /** @class */ (function () {
    function ArtistProfileComponent(ArtistProfileService, toastr, route, router, lightbox, MessageService, modalService, fb) {
        ...
        this.share_form = this.fb.group({
            email: ['', [__WEBPACK_IMPORTED_MODULE_9__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_9__angular_forms__["Validators"].email]]
        });
                        ...
                        that.ArtistProfileService.getAllTrack(dataTablesParameters).subscribe(function (response) {
                            ...
                            if (that.artisttrack.length > 0) {
                                ...
                                if (that.user && that.user['user']) {
                                    that.ArtistProfileService.getBookmarkedTrackList().subscribe(function (response) {
                                        console.log('bookmarked', response);
                                        var bookmark_list = response['bookmark'];
                                        that.artisttrack.forEach(function (ele) {
                                            var flag = false;
                        ...
                        that.ArtistProfileService.getAllRanking(dataTablesParameters).subscribe(function (response) {
                            ...
                            if (that.user && that.user['user']) {
                                that.ArtistProfileService.getBookmarkedTrackList().subscribe(function (response) {
                                    console.log('bookmarked', response);
                                    var bookmark_list = response['bookmark'];
                                    that.rankingtrack.forEach(function (ele) {
                                        var flag = false;
                                        bookmark_list.forEach(function (bookmark) {
                                            if (bookmark['track_id']['_id'] == ele['_id']) {
                                                flag = true;
    ...
    ArtistProfileComponent.prototype.bookMarkTrack = function (id, index, type) {
        var _this = this;
        if (this.user && this.user['user']) {
            if (type == 'track') {
                ...
                this.ArtistProfileService.bookmarkTrack(data).subscribe(function (response) {
                    _this.toastr.success(response['message'], 'Success!');
                }, function (error) {
                    _this.artisttrack[index]['is_bookmarked'] = !_this.artisttrack[index]['is_bookmarked'];
                    _this.toastr.error(error['error'].message, 'Error!');
                });
            }
            else {
                ...
                this.ArtistProfileService.bookmarkTrack(data).subscribe(function (response) {
                    ...
                    _this.rankingtrack[index]['is_bookmarked'] = !_this.rankingtrack[index]['is_bookmarked'];
                    _this.toastr.error(error['error'].message, 'Error!');
                });
            }
        }
...
var ArtistProfileService = /** @class */ (function () {
    ...
    ArtistProfileService.prototype.getBookmarkedTrackList = function () {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
        return this.http.get(this.api_host + "/user/bookmark", { headers: this.headers });
    };
    // bookmark any track
    ArtistProfileService.prototype.bookmarkTrack = function (data) {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/dashboard/dashboard.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__layout_dashboard_layout_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/layout/dashboard-layout.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__layout_dashboard_layout_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/layout/dashboard-layout.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__whatsnew_whatsnew_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/whatsnew/whatsnew.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__artist_artist_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist/artist.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__artist_comments_comments_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_comments/comments.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__track_comments_track_comments_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/track_comments/track_comments.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__artist_track_comments_artist_track_comments_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_track_comments/artist_track_comments.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__artist_profile_artist_profile_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_profile/artist_profile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__vote_vote_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/vote/vote.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__my_profile_myProfile_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/my_profile/myProfile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__my_music_my_music_component__ = __webpack_require__("../../../../../src/app/dashboard-layout/my_music/my_music.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__layout_dashboard_layout_module__ = __webpack_require__("../../../../../src/app/dashboard-layout/layout/dashboard-layout.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__shared_carousel_carousel_module__ = __webpack_require__("../../../../../src/app/shared/carousel/carousel.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__angular_http__ = __webpack_require__("../../../http/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__angular_common_http__ = __webpack_require__("../../../common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__header_header_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/header/header.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__my_profile_myProfile_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/my_profile/myProfile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__my_music_my_music_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/my_music/my_music.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__whatsnew_whatsnew_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/whatsnew/whatsnew.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__artist_artist_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist/artist.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__artist_comments_comments_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_comments/comments.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__track_comments_track_comments_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/track_comments/track_comments.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__artist_track_comments_artist_track_comments_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_track_comments/artist_track_comments.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__artist_profile_artist_profile_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/artist_profile/artist_profile.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__ = __webpack_require__("../../../../../src/app/dashboard-layout/resolve/artist_resolve/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__ = __webpack_require__("../../../../../src/app/dashboard-layout/resolve/track_comment_resolve/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__dashboard_dashboard_service__ = __webpack_require__("../../../../../src/app/dashboard-layout/dashboard/dashboard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__angular_forms__ = __webpack_require__("../../../forms/esm5/forms.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37_ngx_toastr__ = __webpack_require__("../../../../ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_angular2_lightbox__ = __webpack_require__("../../../../angular2-lightbox/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_angular2_lightbox___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_38_angular2_lightbox__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39_time_ago_pipe__ = __webpack_require__("../../../../time-ago-pipe/esm5/time-ago-pipe.js");
    ...
    LayoutModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_20__layout_dashboard_layout_module__["a" /* DashboardLayoutModule */],
                __WEBPACK_IMPORTED_MODULE_21__shared_carousel_carousel_module__["a" /* CarouselModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_37_ngx_toastr__["a" /* ToastrModule */].forRoot(),
                ...
                __WEBPACK_IMPORTED_MODULE_38_angular2_lightbox__["LightboxModule"],
                __WEBPACK_IMPORTED_MODULE_5_angular_datatables__["b" /* DataTablesModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["RouterModule"].forChild([
                    {
                        path: '',
                        component: __WEBPACK_IMPORTED_MODULE_9__layout_dashboard_layout_component__["a" /* DashboardLayoutComponent */],
                        children: [
                            { path: '', component: __WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_component__["a" /* DashboardComponent */] },
                            { path: 'whats-new', component: __WEBPACK_IMPORTED_MODULE_11__whatsnew_whatsnew_component__["a" /* WhatsNewComponent */] },
                            { path: 'artist', component: __WEBPACK_IMPORTED_MODULE_12__artist_artist_component__["a" /* ArtistComponent */] },
                            { path: 'artist_track_comment/:id', component: __WEBPACK_IMPORTED_MODULE_15__artist_track_comments_artist_track_comments_component__["a" /* ArtistTrackConmmentsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_41__shared_auth_service__["a" /* AuthService */]] },
                            { path: 'artist_profile/:artist_id/track/:id/comments', component: __WEBPACK_IMPORTED_MODULE_14__track_comments_track_comments_component__["a" /* TrackConmmentsComponent */], resolve: { comment: __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["b" /* TrackCommentResolve */], artist: __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["a" /* TrackArtistProfileResolve */], track: __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["c" /* TrackDetailResolve */] } },
                            { path: 'artist_profile/:id/comments', component: __WEBPACK_IMPORTED_MODULE_13__artist_comments_comments_component__["a" /* ConmmentsComponent */], resolve: { artist: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["d" /* ArtistProfileResolve */], comments: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["a" /* ArtistCommentsResolve */] } },
                            { path: 'artist_profile/:id', component: __WEBPACK_IMPORTED_MODULE_16__artist_profile_artist_profile_component__["a" /* ArtistProfileComponent */], resolve: { artist: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["d" /* ArtistProfileResolve */], media: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["c" /* ArtistMediaResolve */], follower: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["b" /* ArtistFollowerResolve */], comments: __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["a" /* ArtistCommentsResolve */] } },
                            { path: 'vote', component: __WEBPACK_IMPORTED_MODULE_17__vote_vote_component__["a" /* VoteComponent */] },
                            { path: 'my-music', component: __WEBPACK_IMPORTED_MODULE_19__my_music_my_music_component__["a" /* MyMusicComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_41__shared_auth_service__["a" /* AuthService */]] },
                            { path: 'my-profile', component: __WEBPACK_IMPORTED_MODULE_18__my_profile_myProfile_component__["a" /* MyProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_41__shared_auth_service__["a" /* AuthService */]] }
                        ]
                    }
                ])
            ],
            declarations: [__WEBPACK_IMPORTED_MODULE_8__dashboard_dashboard_component__["a" /* DashboardComponent */],
                __WEBPACK_IMPORTED_MODULE_11__whatsnew_whatsnew_component__["a" /* WhatsNewComponent */],
                __WEBPACK_IMPORTED_MODULE_12__artist_artist_component__["a" /* ArtistComponent */],
                __WEBPACK_IMPORTED_MODULE_13__artist_comments_comments_component__["a" /* ConmmentsComponent */],
                __WEBPACK_IMPORTED_MODULE_17__vote_vote_component__["a" /* VoteComponent */],
                __WEBPACK_IMPORTED_MODULE_18__my_profile_myProfile_component__["a" /* MyProfileComponent */],
                __WEBPACK_IMPORTED_MODULE_19__my_music_my_music_component__["a" /* MyMusicComponent */],
                __WEBPACK_IMPORTED_MODULE_6_angular_io_slimscroll__["SlimScroll"],
                __WEBPACK_IMPORTED_MODULE_16__artist_profile_artist_profile_component__["a" /* ArtistProfileComponent */],
                __WEBPACK_IMPORTED_MODULE_14__track_comments_track_comments_component__["a" /* TrackConmmentsComponent */],
                __WEBPACK_IMPORTED_MODULE_15__artist_track_comments_artist_track_comments_component__["a" /* ArtistTrackConmmentsComponent */],
                __WEBPACK_IMPORTED_MODULE_39_time_ago_pipe__["a" /* TimeAgoPipe */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_24__header_header_service__["a" /* HeaderService */],
                __WEBPACK_IMPORTED_MODULE_41__shared_auth_service__["a" /* AuthService */],
                __WEBPACK_IMPORTED_MODULE_25__my_profile_myProfile_service__["a" /* MyProfileService */],
                __WEBPACK_IMPORTED_MODULE_26__my_music_my_music_service__["a" /* MyMusicService */],
                __WEBPACK_IMPORTED_MODULE_27__whatsnew_whatsnew_service__["a" /* WhatsNewService */],
                __WEBPACK_IMPORTED_MODULE_28__artist_artist_service__["a" /* ArtistService */],
                __WEBPACK_IMPORTED_MODULE_29__artist_comments_comments_service__["a" /* CommentsService */],
                __WEBPACK_IMPORTED_MODULE_35__dashboard_dashboard_service__["a" /* DashboardService */],
                __WEBPACK_IMPORTED_MODULE_31__artist_track_comments_artist_track_comments_service__["a" /* ArtistTrackCommentsService */],
                __WEBPACK_IMPORTED_MODULE_32__artist_profile_artist_profile_service__["a" /* ArtistProfileService */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["d" /* ArtistProfileResolve */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["f" /* ArtistTrackResolve */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["c" /* ArtistMediaResolve */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["a" /* ArtistCommentsResolve */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["b" /* ArtistFollowerResolve */],
                __WEBPACK_IMPORTED_MODULE_33__resolve_artist_resolve__["e" /* ArtistRankingResolve */],
                __WEBPACK_IMPORTED_MODULE_30__track_comments_track_comments_service__["a" /* TrackCommentsService */],
                __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["b" /* TrackCommentResolve */],
                __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["a" /* TrackArtistProfileResolve */],
                __WEBPACK_IMPORTED_MODULE_34__resolve_track_comment_resolve__["c" /* TrackDetailResolve */],
                __WEBPACK_IMPORTED_MODULE_10__layout_dashboard_layout_service__["a" /* DashboardLayoutService */]
            ]
        })
    ], LayoutModule);
    return LayoutModule;
...
var DashboardLayoutComponent = /** @class */ (function () {
    function DashboardLayoutComponent(MessageService, DashboardLayoutService, toastr, modalService, fb) {
        ...
        this.share_form_phone = this.fb.group({
            phone: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].maxLength(10), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(10)]]
        });
    }
...
var MyMusicComponent = /** @class */ (function () {
    function MyMusicComponent(modalService, MyMusicService, toastr, MessageService, fb) {
        ...
        this.share_form = this.fb.group({
            email: ['', [__WEBPACK_IMPORTED_MODULE_7__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["Validators"].email]]
        });
        this.share_form_phone = this.fb.group({
            phone: ['', [__WEBPACK_IMPORTED_MODULE_7__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["Validators"].maxLength(10), __WEBPACK_IMPORTED_MODULE_7__angular_forms__["Validators"].minLength(10)]]
        });
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_sweetalert2__ = __webpack_require__("../../../../sweetalert2/dist/sweetalert2.all.js");
...
var MyProfileComponent = /** @class */ (function () {
    function MyProfileComponent(MyProfileService, toastr, router, modalService, lightbox, MessageService, AmCharts, fb) {
        ...
        this.upgrade_artist_validation = false;
        this.upgrade_artist_data = {};
        this.region_list = [];
        this.state_list = [];
        this.upgrade_artist_img = '';
        // playlist
        this.playlist = [];
        this.playlist_data = {};
        this.playlist_track = [];
        this.serach_track_list = [];
        this.search_track = '';
        ...
        if (data && data.artist) {
            ...
            this.upgrade_artist_data = __assign({}, this.userdata, { share_url: share_url });
        ...
        this.artist_profile = this.fb.group({
            ...
            day: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            month: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            year: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            phone: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].pattern('[0-9]+'), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].minLength(10), __WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].maxLength(10)]],
            music_type: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            zipcode: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            description: [''],
            share_url_fb: [''],
            share_url_insta: [''],
            share_url_twit: [''],
        ...
        this.upgrade_artist = this.fb.group({
            ...
            state: ['', [__WEBPACK_IMPORTED_MODULE_3__angular_forms__["Validators"].required]],
            description: [''],
            share_url_fb: [''],
            share_url_insta: [''],
            share_url_twit: [''],
        ...
        this.subscription = this.MessageService.getMessage().subscribe(function (response) {
            ...
            if (response && response['loggedin_user']) {
                ...
                if (data && data.artist) {
                    _this.userdata = __assign({}, data['artist']);
                    ...
                    _this.userdata = __assign({}, data['user']);
                    ...
                    _this.userdata['music_type'] = tmp_2;
                }
            }
        });
    }
        ...
        if (this.userdata['type'] == 'artist') {
            ...
            this.dtOptions[0] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that_1.audio_ins = [];
                    that_1.MyProfileService.getArtistPlaylist(dataTablesParameters).subscribe(function (response) {
                        that_1.playlist = response['playlist'];
                        callback({
                            recordsTotal: response['recordsTotal'],
            ...
            this.dtOptions[0] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that_2.audio_ins = [];
                    that_2.MyProfileService.getBookmarkedTrack(dataTablesParameters).subscribe(function (response) {
                        that_2.bookmark_list = response['bookmark'];
                        if (that_2.bookmark_list.length > 0) {
                            _this.audio_ins = [];
                            _this.bookmark_track_list = [];
                            _this.bookmark_list.forEach(function (ele) { _this.audio_ins.push(false); });
                            _this.bookmark_list.forEach(function (ele) { _this.bookmark_track_list.push(ele['track_id']); });
                        }
                        callback({
                            recordsTotal: response['recordsTotal'],
                            recordsFiltered: response['recordsFiltered'],
            ...
            this.dtOptions[1] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that_2.audio_ins = [];
                    that_2.MyProfileService.getAllListenerPlaylist(dataTablesParameters).subscribe(function (response) {
                        that_2.playlist = response['playlist'];
                        callback({
                            recordsTotal: response['recordsTotal'],
                            recordsFiltered: response['recordsFiltered'],
                            data: []
    ...
    MyProfileComponent.prototype.changeUpgradeArtistImage = function (event) {
        var _this = this;
        var fileList = event.target.files;
        if (event.target.files.length > 0) {
            var allow_types = ['image/png', 'image/jpg', 'image/jpeg'];
    ...
    // Play audio
    MyProfileComponent.prototype.playAudio = function (name, index, data) {
        var _this = this;
        data.forEach(function (ele, idx) {
            _this.audio_ins[idx] = false;
        });
    ...
    // Stop audio
    MyProfileComponent.prototype.stopAudio = function (index, data) {
        var _this = this;
        data.forEach(function (ele, idx) {
            _this.audio_ins[idx] = false;
        });
    ...
    MyProfileComponent.prototype.openAddPlaylistModel = function (content) {
        this.playlist_data = {};
        this.media_modal_ref = this.modalService.open(content, { centered: true });
    };
    // open edit playlist model
    MyProfileComponent.prototype.openEditPlaylistModel = function (content, index) {
        this.playlist_data = this.playlist[index];
        this.media_modal_ref = this.modalService.open(content, { centered: true });
    };
    // open edit playlist model
    MyProfileComponent.prototype.openPlaylistTrackModel = function (content) {
        this.media_modal_ref = this.modalService.open(content, { centered: true });
    };
    // add new playlist to db
    MyProfileComponent.prototype.addNewPlaylist = function () {
        var _this = this;
        if (this.userdata && this.userdata['type'] == 'user') {
            if (this.playlist_data && this.playlist_data['name'] && this.playlist_data['name'] != null) {
                this.show_spinner = true;
                this.MyProfileService.addNewListenerPlaylist(this.playlist_data).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
            ...
            if (this.playlist_data && this.playlist_data['name'] && this.playlist_data['name'] != null) {
                this.show_spinner = true;
                this.MyProfileService.createArtistPlaylist(this.playlist_data).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
    ...
    MyProfileComponent.prototype.editPlaylist = function () {
        var _this = this;
        if (this.userdata && this.userdata['type'] == 'user') {
            if (this.playlist_data && this.playlist_data['name'] && this.playlist_data['name'] != null) {
                this.show_spinner = true;
                this.MyProfileService.updateListenerPlaylist(this.playlist_data, this.playlist_data['_id']).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
            ...
            if (this.playlist_data && this.playlist_data['name'] && this.playlist_data['name'] != null) {
                this.show_spinner = true;
                this.MyProfileService.updateArtistPlaylist(this.playlist_data, this.playlist_data['_id']).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
    ...
    MyProfileComponent.prototype.removePlaylist = function (id) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_13_sweetalert2___default()({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            if (flag.value) {
                if (_this.userdata && _this.userdata['type'] == 'user') {
                    _this.MyProfileService.deleteListenerPlaylistById(id).subscribe(function (response) {
                        _this.toastr.success(response['message'], 'Success!');
                        _this.dtElements.forEach(function (dtElement, index) {
                            dtElement.dtInstance.then(function (dtInstance) {
                                dtInstance.draw();
                    ...
                    _this.MyProfileService.removeArtistPlaylist(id).subscribe(function (response) {
                        _this.toastr.success(response['message'], 'Success!');
                        _this.dtElements.forEach(function (dtElement, index) {
                            dtElement.dtInstance.then(function (dtInstance) {
                                dtInstance.draw();
    ...
    // Playlist track
    MyProfileComponent.prototype.getPlaylistTrack = function (id, index) {
        var _this = this;
        var that = this;
        ...
        if (this.userdata && this.userdata['type'] == 'user') {
            this.dtOptions[2] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that.audio_ins = [];
                    that.MyProfileService.getPlaylistTrack(dataTablesParameters, id).subscribe(function (response) {
                        that.playlist_track = response['playlist'];
                        if (that.playlist_track.length > 0) {
                            _this.audio_ins = [];
                            _this.playlist_track_list = [];
                            _this.playlist_track.forEach(function (ele) { _this.audio_ins.push(false); });
                            _this.playlist_track.forEach(function (ele) { _this.playlist_track_list.push(ele['track']); });
                        }
                        callback({
                            recordsTotal: response['recordsTotal'],
                            recordsFiltered: response['recordsFiltered'],
            ...
            this.dtOptions[1] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that.audio_ins = [];
                    that.MyProfileService.getArtistPlaylistTrack(dataTablesParameters, id).subscribe(function (response) {
                        that.playlist_track = response['playlist'];
                        if (that.playlist_track.length > 0) {
                            _this.audio_ins = [];
                            _this.playlist_track_list = [];
    ...
    MyProfileComponent.prototype.search = function (event) {
        ...
        this.MyProfileService.getTrackForPlaylist(data).subscribe(function (response) {
            _this.serach_track_list = response['track'];
        });
    };
    // Add track to playlist
    MyProfileComponent.prototype.addTrackPlaylist = function () {
        var _this = this;
        if (this.userdata && this.userdata['type'] == 'user') {
            ...
            if (this.search_track) {
                ...
                this.search_track.forEach(function (ele) { data_1['track_id'].push(ele['_id']); });
                this.show_spinner = true;
                this.MyProfileService.addTrackListenerPlaylist(data_1, this.playlist_data['_id']).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
            ...
            if (this.search_track) {
                ...
                this.search_track.forEach(function (ele) { data_2['track_id'].push(ele['_id']); });
                this.show_spinner = true;
                this.MyProfileService.addTrackToArtistPlaylist(data_2, this.playlist_data['_id']).subscribe(function (response) {
                    _this.dtElements.forEach(function (dtElement, index) {
                        dtElement.dtInstance.then(function (dtInstance) {
                            dtInstance.draw();
                        });
    ...
    MyProfileComponent.prototype.removeTrackFromPlaylist = function (id) {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_13_sweetalert2___default()({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            if (flag.value) {
                if (_this.userdata && _this.userdata['type'] == 'user') {
                    var data = {
                        track_id: id,
                        playlist_id: _this.playlist_data['_id']
                    };
                    _this.MyProfileService.removeTrackListenerPlaylist(data).subscribe(function (response) {
                        _this.toastr.success(response['message'], 'Success!');
                        _this.dtElements.forEach(function (dtElement, index) {
                            dtElement.dtInstance.then(function (dtInstance) {
                                dtInstance.draw();
                    ...
                    _this.MyProfileService.removeTrackFromArtistPlaylist(data).subscribe(function (response) {
                        _this.toastr.success(response['message'], 'Success!');
                        _this.dtElements.forEach(function (dtElement, index) {
                            dtElement.dtInstance.then(function (dtInstance) {
                                dtInstance.draw();
    ...
    MyProfileComponent.prototype.getRegionList = function () {
        var _this = this;
        this.MyProfileService.getAllRegion().subscribe(function (response) {
            _this.region_list = response['Region'];
        });
    };
    MyProfileComponent.prototype.getStateByRegion = function (id) {
        var _this = this;
        if (id && id != "") {
            this.MyProfileService.getStateByRegion({ region: id }).subscribe(function (response) {
                _this.state_list = response['state'];
            });
        }
    };
    // upgrade to artist
    MyProfileComponent.prototype.upgradeToArtist = function (flag, profile_img) {
        if (flag && profile_img != '') {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])(__WEBPACK_IMPORTED_MODULE_12_angular_datatables__["a" /* DataTableDirective */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["QueryList"])
    ], MyProfileComponent.prototype, "dtElements", void 0);
...
var MyProfileService = /** @class */ (function () {
    function MyProfileService(http, MessageService) {
        var _this = this;
        this.http = http;
        this.MessageService = MessageService;
        this.api_host = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].API_URL;
        ...
        this.MessageService.getMessage().subscribe(function (response) {
            if (response && response['loggedin_user']) {
                _this.user = response['loggedin_user'];
                _this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': _this.user.token });
            }
        });
    }
    // get All music type
    ...
    MyProfileService.prototype.removeTrackFromArtistPlaylist = function (data) {
        return this.http.put(this.api_host + "/artist/playlist/track", data, { headers: this.headers });
    };
    // get all region
    MyProfileService.prototype.getAllRegion = function () {
        return this.http.get(this.api_host + "/region");
    };
    // Get state based on region
    MyProfileService.prototype.getStateByRegion = function (data) {
        return this.http.post(this.api_host + "/state_by_region", data);
    };
    // upgrade to artist
    MyProfileService.prototype.upgradeToArtist = function (data) {
        return this.http.post(this.api_host + "/user/upgrade_to_artist", data, { headers: this.headers });
    };
    MyProfileService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_4__shared_message_service__["a" /* MessageService */]])
    ], MyProfileService);
...
var TrackConmmentsComponent = /** @class */ (function () {
    ...
    // upvote commnet
    TrackConmmentsComponent.prototype.upVoteComment = function (id) {
        var _this = this;
        if (this.user && this.user['user']) {
            var data = {
                comment_id: id
            };
            this.TrackCommentsService.upVoteComment(data).subscribe(function (response) {
                _this.getAllTrackComment();
                _this.toastr.success(response['message'], 'Success!');
            }, function (error) {
                _this.toastr.error(error['error'].message, 'Error!');
    ...
    // downvote commnet
    TrackConmmentsComponent.prototype.downVoteComment = function (id) {
        var _this = this;
        if (this.user && this.user['user']) {
            var data = {
                comment_id: id
            };
            this.TrackCommentsService.downVoteComment(data).subscribe(function (response) {
                _this.getAllTrackComment();
                _this.toastr.success(response['message'], 'Success!');
            }, function (error) {
                _this.toastr.error(error['error'].message, 'Error!');
...
var TrackCommentsService = /** @class */ (function () {
    ...
    // upvote comment
    TrackCommentsService.prototype.upVoteComment = function (data) {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
        return this.http.post(this.api_host + "/user/comment/upvote", data, { headers: this.headers });
    };
    // Downvote comment
    TrackCommentsService.prototype.downVoteComment = function (data) {
        this.user = JSON.parse(localStorage.getItem('user'));
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'x-access-token': this.user.token });
        return this.http.post(this.api_host + "/user/comment/downvote", data, { headers: this.headers });
    };
...
var ForgetPasswordComponent = /** @class */ (function () {
    function ForgetPasswordComponent(fb, ForgetPasswordService, toastr, route, router) {
        ...
        this.passwordFormGroup = this.fb.group({
            ...
            conf: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(6)]]
        }, {
            validator: this.passwordMatchValidator
        });
        this.route.params.subscribe(function (res) {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb, RegisterService, toastr, router, socialAuthService, MessageService) {
        ...
        this.artist_step1 = this.fb.group({
            terms_condtion: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]
        });
        this.passwordFormGroup1 = this.fb.group({
            artist_password: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(6)],
            artist_conf: ['', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(6)]
        }, {
            validator: this.passwordMatchValidator
        });
        this.passwordFormGroup = this.fb.group({
        ...
        this.artist_step3 = this.fb.group({
            ...
            day: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            month: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            year: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            phone: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('[0-9]+'), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].minLength(10), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].maxLength(10)]]
        });
        this.artist_step4 = this.fb.group({
            zipcode: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('^[A-Za-z0-9]+$')]],
        ...
        this.listener_step4 = this.fb.group({
            zipcode: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('^[0-9]+$')]],
            region: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]],
            state: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]]
        });
