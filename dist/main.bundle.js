        ...
        if (this.userdata['type'] == 'artist') {
            ...
            this.dtOptions[0] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that_1.audio_ins = [];
                    that_1.MyProfileService.getBookmarkedTrack(dataTablesParameters).subscribe(function (response) {
                        that_1.bookmark_list = response['bookmark'];
                        if (that_1.bookmark_list.length > 0) {
                            _this.audio_ins = [];
            ...
            this.dtOptions[1] = {
                ...
                ajax: function (dataTablesParameters, callback) {
                    console.log(dataTablesParameters);
                    that_1.audio_ins = [];
                    that_1.MyProfileService.getAllListenerPlaylist(dataTablesParameters).subscribe(function (response) {
