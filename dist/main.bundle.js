...
var RolesComponent = /** @class */ (function () {
    ...
    RolesComponent.prototype.sortArtist = function () {
        this.datatableElement.dtInstance.then(function (dtInstance) {
            dtInstance.draw();
        });
    };
    ...
    // Create new admin
    RolesComponent.prototype.addNewAdmin = function () {
        var _this = this;
    ...
    // remove admin 
    RolesComponent.prototype.removeAdmin = function (id) {
        var thi = this;
        swal({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            thi.RolesService.deleteAdmin(id).subscribe(function (response) {
                thi.toastr.success(response['message'], 'Success!');
                thi.datatableElement.dtInstance.then(function (dtInstance) {
                    dtInstance.draw();
                });
            }, function (error) {
                thi.toastr.error(error['error'].message, 'Error!');
    ...
    RolesComponent.prototype.suspendAdmin = function (id) {
        var thi = this;
        swal({
            title: 'Are you sure?',
    ...
    ], RolesComponent.prototype, "datatableElement", void 0);
...
var DashboardLayoutComponent = /** @class */ (function () {
    function DashboardLayoutComponent() {
        ...
        this.audio_instance_list = [];
        this.audio_list.forEach(function (ele) {
            var audio = new Audio();
            audio.src = ele;
            audio.load();
    ...
    DashboardLayoutComponent.prototype.ngAfterViewInit = function () {
        ...
        this.timeline.addEventListener("click", function (event) {
            ...
            if (_this.audio_ins) {
                _this.audio_ins.currentTime = _this.duration * _this.clickPercent(event);
            }
        }, false);
