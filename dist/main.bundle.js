...
var ForgetPasswordComponent = /** @class */ (function () {
    function ForgetPasswordComponent(fb, ForgetPasswordService, toastr, route, router) {
        ...
        this.param = {};
        this.passwordFormGroup = this.fb.group({
            password: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].maxLength(6)]],
            conf: ['', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].maxLength(6)]]
        }, {
            validator: this.passwordMatchValidator
        });
        this.route.params.subscribe(function (res) {
