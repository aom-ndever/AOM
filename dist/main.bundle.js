...
var DashboardLayoutComponent = /** @class */ (function () {
    function DashboardLayoutComponent(MessageService) {
        var _this = this;
        this.MessageService = MessageService;
