...
export class MyProfileComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    this.artist_profile = this.fb.group({
      upload: [''],
      cover: [''],
      fname: ['', [Validators.required, Validators.pattern('[A-Za-z]+'), this.noWhitespaceValidator]],
      lname: ['', [Validators.required, Validators.pattern('[A-Za-z]+'), this.noWhitespaceValidator]],
