...
import {
  ...
  TrackDetailResolve,
} from "./resolve/track_comment_resolve";
    ...
    RouterModule.forChild([
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: ArtistTrackConmmentsComponent,
          ...
          },
          {
            ...
            resolve: {
              comment: TrackCommentResolve,
              artist: TrackArtistProfileResolve,
              track: TrackDetailResolve,
            },
          ...
          },
          {
            ...
            canActivate: [AuthService],
            data: { title: "AOM | Inbox", edit: false },
          },
        ],
      },
    ]),
