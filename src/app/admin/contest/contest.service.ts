...
export class ContestService {
  ...
  getAllContest(data: any) {
    return this.http.post(`${this.api_host}/admin/contest`, data, {
  ...
  getContestParticipants(data: any) {
    return this.http.post(
      `${this.api_host}/admin/get_participants_of_contest`,
      data,
      { headers: this.headers }
    );
  }
  ...
  getExistingContest() {
    return this.http.get(`${this.api_host}/admin/get_all_contests_for_vote`, {
      headers: this.headers,
    });
  }
  // get all region
  ...
  addNewContest(data: any) {
    return this.http.post(`${this.api_host}/admin/add_contest`, data, {
      headers: this.headers,
    });
  }
  // add existing contest
  addExistingContest(data: any) {
    return this.http.post(`${this.api_host}/admin/add_existing_contest`, data, {
      headers: this.headers,
    });
  }
  // get contest round by contest
  getContestRound(data) {
    return this.http.post(`${this.api_host}/admin/get_round`, data, {
      headers: this.headers,
    });
  }
