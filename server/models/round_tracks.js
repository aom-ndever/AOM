...
var RoundTrackModelSchema = new Schema(
  {
    ...
    round5_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    round6_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    round7_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    round8_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    semi_final_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    final_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
    preliminary1_track: { type: mongoose.Schema.Types.ObjectId, ref: "track" },
...
var RoundTrack = mongoose.model(
  "round_track",
  RoundTrackModelSchema,
  "round_track"
);
