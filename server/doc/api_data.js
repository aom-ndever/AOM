define({ "api": [
  ...
  },
  {
    "type": "post",
    "url": "/admin/home_vote",
    "title": "Artist Vote - post",
    "name": "Artist_Vote__post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/home_comment",
    "title": "Artist comment - post",
    "name": "Artist_comment__post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "artist",
            "description": "<p>comment detail</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "post",
    "url": "/admin/home_like",
    "title": "Artist like - post",
    "name": "Artist_like___post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/suspend/artist/:user_id",
    "title": "Flag User",
    "name": "Flag_User",
    "group": "Admin",
    "header": {
  ...
  },
  {
    "type": "get",
    "url": "/admin/get_flag",
    "title": "Get Flagged artist - Get",
    "name": "Get_Flagged_artist___Get",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Get",
            "description": "<p>Flagged artist document</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/admin/get_flagged_user",
    "title": "Get Flagged user - Get",
    "name": "Get_Flagged_user___Get",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Get",
            "description": "<p>Flagged user document</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "post",
    "url": "/admin/user",
    "title": "Get User by user id- post",
    "name": "Get_User_by_user_id___post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/user/artist_follow",
    "title": "Get followers by user id- post",
    "name": "Get_followers_by_user_id___post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/get_participants_of_contest",
    "title": "Get participants as per conteset id - post",
    "name": "Get_participants_as_per_conteset_id__post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/flag/artist/:artist_id",
    "title": "Flag Artist - post",
    "name": "S_Flag_Artist___post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "post",
    "url": "/admin/suspend/:admin_id",
    "title": "Suspend Admin - post",
    "name": "Suspend_Admin___post",
    "group": "Admin",
    "header": {
      "fields": {
        "Header": [
  ...
  {
    "type": "put",
    "url": "/admin/featured_artist",
    "title": "Update artist as featured - put",
    "name": "Update_artist_as_featured___put",
    "group": "User",
    "header": {
      "fields": {
        "Header": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "artist",
            "description": "<p>featured details</p>"
          }
        ]
      }
    },
